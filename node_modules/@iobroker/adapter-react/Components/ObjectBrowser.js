...
var ObjectBrowser = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2["default"])(ObjectBrowser, [{
    ...
    value: function renderLeaf(item, isExpanded, classes, counter) {
      ...
      var readWriteAlias = (0, _typeof2["default"])((_item$data$obj6 = item.data.obj) === null || _item$data$obj6 === void 0 ? void 0 : (_item$data$obj6$commo = _item$data$obj6.common) === null || _item$data$obj6$commo === void 0 ? void 0 : (_item$data$obj6$commo2 = _item$data$obj6$commo.alias) === null || _item$data$obj6$commo2 === void 0 ? void 0 : _item$data$obj6$commo2.id) === 'object';
        ...
        return /*#__PURE__*/_react["default"].createElement(ObjectCustomDialog, {
          ...
          onClose: function onClose() {
            ...
            if (_this43.changedIds) {
              _this43.changedIds = null; // update all changed IDs
